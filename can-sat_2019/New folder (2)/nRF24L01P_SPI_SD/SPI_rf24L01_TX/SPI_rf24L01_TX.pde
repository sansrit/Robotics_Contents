...
//------------------------------------------------
//IMPORTANT: If SD don't works, then disconnect by a sec the MOSI&MISO pins from transceiver
//------------------------------------------------
