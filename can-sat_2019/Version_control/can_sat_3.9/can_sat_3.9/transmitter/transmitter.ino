...
#include <printf.h>         //header file for rf
...
#define DHTPIN 5                // Digital pin def for DHT 11. Don't connect to pin 0 or pin 1 can define for any other pin
#define DHTTYPE DHT11           // Define DHT11 module.
                    ...
                    #define MPU_CALIBRATE_READING_NUM       1000
...
Package data;
            ...
            void setup() {
              ...
              transmit.stopListening(); //activates transmission modes
              }
